...
<div class="nav_bar">
    ...
    <div class="nav_title">补交征信报告</div>
</div>
<!--顶部导航栏2-->
<div class="nav_bar2">
...
<div class="ibox-content box_h2 container">
    ...
    <div class="ibox">
        <div class="ibox-title del-line">
            <h5><font><font>征信报告:</font></font></h5>
            <button type="button" class="btn btn-primary btn-xs pull-right w20" id="report_btn">提交</button>
        </div>
        <div class="ibox-content">
            <form action="/company/index/report" method="post" class="dropzone dz-clickable" id="report">
                <input type="hidden" name="id" value="{{ id }}"/>
                <div class="dz-default dz-message">
							<span>
								<strong><font><font>点击这里上传文件或删除</font></font></strong>
							</span>
                </div>
            </form>
        </div>
