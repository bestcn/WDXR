        ...
        <div class="ibox float-e-margins">
            <div class="ibox-title">
                <ul class="nav nav-tabs">
                    ...
                    <li class="active">{{ acl_button(["admin/sms/account", '用户通过后通知用户的账号密码信息']) }}</li>
                                                ...
                                                <div class="form-horizontal">
                                                    ...
                                                    <div class="panel-body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <span>尊敬的{1}，您的账号是 {2}，初始密码是 {3}。为了您的账户安全，请在初次登录后修改密码</span>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="fieldBranch_name" class="col-sm-2 control-label">用户账号</label>
                                                            <div class="col-sm-8">
                                                                <textarea name="user" id="user" class="form-control" placeholder="填写多个号码时，用户账号顺序请与电话号码一一对应"></textarea>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="fieldBranch_name" class="col-sm-2 control-label">初始密码</label>
                                                            <input name="password" id="password" placeholder="统一初始密码">
                                                        </div>


                                                        <div class="hr-line-dashed"></div>
                                                        <div class="col-sm-offset-2 col-sm-10">
                                                            {{ acl_button(["admin/sms/account", '发送', 'href':'javascript:send()', 'class':'btn btn-primary']) }}
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h5 class="modal-title" id="modal-title">用户的账号密码信息</h5>
...
<script type="text/javascript">
    function send() {
        ...
        $.ajax({
            type : "POST",
            url : "{{ url('admin/sms/account') }}",
            data : {phone:phone,name:name,user:user,password:password},
