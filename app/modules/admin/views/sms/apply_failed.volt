        ...
        <div class="ibox float-e-margins">
            <div class="ibox-title">
                <ul class="nav nav-tabs">
                    ...
                    <li class="active">{{ acl_button(["admin/sms/apply_failed", '多类型审核驳回']) }}</li>
                </ul>
            </div>
                                                ...
                                                <div class="form-horizontal">
                                                    ...
                                                    <div class="panel-body">
                                                        ...
                                                        <div class="col-sm-offset-2 col-sm-10">
                                                            {{ acl_button(["admin/sms/apply_failed", '发送', 'href':'javascript:send()', 'class':'btn btn-primary']) }}
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h5 class="modal-title" id="modal-title">多类型审核驳回</h5>
...
<script type="text/javascript">
    function send() {
        ...
        $.ajax({
            type : "POST",
            url : "{{ url('admin/sms/apply_failed') }}",
