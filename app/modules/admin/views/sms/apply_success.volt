        ...
        <div class="ibox float-e-margins">
            <div class="ibox-title">
                <ul class="nav nav-tabs">
                    ...
                    <li class="active">{{ acl_button(["admin/sms/apply_success", '多类型审核通过']) }}</li>
                                            ...
                                            <div class="tab-pane active">
                                                <div class="form-horizontal">
                                                    ...
                                                    <div class="panel-body">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="fieldBranch_name" class="col-sm-2 control-label">审核类型</label>
                                                            <input name="type" id="type" placeholder="统一类型名称">
                                                        </div>


                                                        <div class="hr-line-dashed"></div>
                                                        <div class="col-sm-offset-2 col-sm-10">
                                                            {{ acl_button(["admin/sms/apply_success", '发送', 'href':'javascript:send()', 'class':'btn btn-primary']) }}
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h5 class="modal-title" id="modal-title">多类型审核通过</h5>
...
<script type="text/javascript">
    function send() {
        ...
        $.ajax({
            type : "POST",
            url : "{{ url('admin/sms/apply_success') }}",
