        ...
        <div class="ibox float-e-margins">
            <div class="ibox-title">
                <ul class="nav nav-tabs">
                    ...
                    <li class="active">{{ acl_button(["admin/sms/bill", '短信通知用户票据的审核期限']) }}</li>
                                                ...
                                                <div class="form-horizontal">
                                                    ...
                                                    <div class="panel-body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <span>尊敬的{1}，请及时联系您的客户经理，在{2}之前上传您的票据材料</span>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                        ...
                                                        <div class="col-sm-offset-2 col-sm-10">
                                                            {{ acl_button(["admin/sms/bill", '发送', 'href':'javascript:send()', 'class':'btn btn-primary']) }}
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h5 class="modal-title" id="modal-title">通知用户票据的审核期限</h5>
