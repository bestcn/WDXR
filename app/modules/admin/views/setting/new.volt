<div class="row">
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            <div class="ibox-title"><h5>添加新版本</h5></div>
            <div class="ibox-content">
                <form action="/admin/setting/new" class="form-horizontal" method="post" autocomplete="off">
                    <div class="form-group">
                    <label for="fieldBranch_name" class="col-sm-2 control-label">版本号</label>
                    <div class="col-sm-4">
                        <input type="text" id="id" name="id" class="form-control" placeholder="请填写版本号">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" id="url" name="url" class="form-control" placeholder="请填写下载地址">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            ...
                            <textarea id="log" name="log" class="form-control" placeholder="请填写更新日志">
