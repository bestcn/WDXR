<div class="row">
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            <div class="ibox-title"><h5>普惠补录</h5></div>
            <div class="ibox-content">
                {{ form("admin/loan/edit_info/"~verify.id, "method":"post", "autocomplete" : "off", "class" : "form-horizontal") }}
                ...
                <div class="form-group">
                    ...
                    <label for="fieldBranch_admin" class="col-sm-2 control-label">驳回原因</label>
                    <div class="col-sm-4">
                        {{ verify.remark }}
                    </div>
                </div>
                <div class="form-group">
                    <label for="fieldBranch_admin" class="col-sm-2 control-label">业务员</label>
                    <div class="col-sm-4">
                        {{ admin.name }}
                    </div>
                    <label for="fieldBranch_admin" class="col-sm-2 control-label">联系电话</label>
                    <div class="col-sm-4">
                        {{ loan.tel }}
                    </div>
                </div>
