    ...
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                {{ form("admin/companys/add_level", "method":"post", "autocomplete" : "off", "class" : "form-horizontal") }}
                ...
                <div class="form-group">
                    ...
                    <label for="fieldBrancharea" class="col-sm-2 control-label">每日返现金额</label>
                ...
                <div class="form-group">
                    <label for="fieldBrancharea" class="col-sm-2 control-label">是否默认级别</label>
                    <div class="col-sm-2">{{ form.render('is_default') }}</div>
                </div>
