...
class Classification
{
    ...
    public function __construct($dataSource = null)
    {
        ...
        $className = '\Category\Data\\'.$this->dataSource;
    ...
    public function getTopCategory()
    {
        ...
        foreach ($this->data as $item) {
            if(strcmp($item['code'], $item['top_category']) === 0)
            {
                array_push($o, ['code' => $item['code'],'name' => $item['name']]);
            }
        }
        return $o;
    }

    public function getSelectArray($top_category = null)
    {
        $o = [];
        foreach ($this->data as $key => $value) {
            ...
            if(is_null($top_category) ) {
                ...
                if(strcmp($top_category, $value['top_category']) !== 0) {
                    continue;
                }
                array_push($o, ['code' => $value['code'], 'name' => $value['name']]);
            }
        }
        return $o;
    }
