...
# Database: wdxr
# Generation Time: 2017-05-23 09:13:35 +0000
# ************************************************************
...
CREATE TABLE `company_payment` (
  ...
  `type` tinyint(4) DEFAULT '1' COMMENT '缴费方式\n1 转账\n2 现金\n3 POS\n4 贷款\n',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `companys` (
  ...
  `recommend_id` bigint(20) DEFAULT NULL COMMENT '推荐人或企业ID',
  `manager_id` bigint(20) DEFAULT NULL COMMENT '推荐管理员',
  PRIMARY KEY (`id`),
