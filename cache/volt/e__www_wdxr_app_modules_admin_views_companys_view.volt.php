    ...
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            <div class="ibox-title">
                ...
                <?= Wdxr\Modules\Admin\Tags\MenuTags::acl_button(['admin/companys/edit/' . $company['id'], '修改', 'class' => 'btn btn-default btn-xs']); ?>
                <?= Wdxr\Modules\Admin\Tags\MenuTags::acl_button(['admin/companys/contract/' . $company['id'], '查看合同', 'class' => 'btn btn-default btn-xs']); ?>
                            ...
                            <div class="panel-body">
                                <?php if ($bank['number']) { ?>
                                    <table class="table table-hover">
                                        ...
                                        <tr><th>开户人</th><td><?= (empty($bank['account']) ? ($info['legal_name']) : ($bank['account'])) ?></td></tr>
                            ...
                            <div class="panel-body">
                                <?php if ($bank['work_number']) { ?>
                                    <table class="table table-hover">
                                        ...
                                        <tr><th>开户人</th><td><?= (empty($bank['work_account']) ? ($info['legal_name']) : ($bank['work_account'])) ?></td></tr>
