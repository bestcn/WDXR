    ...
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                <?= $this->tag->form(['method' => 'post', 'autocomplete' => 'off', 'class' => 'form-horizontal']) ?>
                    ...
                    <div class="col-sm-10">
                        <table class="table table-striped">
                            ...
                            <?php foreach ($resources as $resource) { ?>
                                <tr>
                                    <td><input type="checkbox" <?php if (($resource['is_check'])) { ?>checked<?php } ?> name="acl[]" value="<?= $resource['resource_name'] ?>||<?= $resource['access_name'] ?>" ></td>
                ...
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        <?= $form->render('submit') ?>
                        <?= Wdxr\Modules\Admin\Tags\MenuTags::acl_button(['admin/acl/index', '返回', 'class' => 'btn btn-default']); ?>
                    </div>
                </div>
                <?= $this->tag->endForm() ?>
            </div>
