    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="ibox-content">
                <?= $this->tag->form(['admin/public/login', 'id' => 'login_form', 'method' => 'post', 'class' => 'm-t', 'role' => 'form']) ?>
                ...
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <div class="input-group-addon" style="padding: 0;">
                            <img onclick="this.src = '<?= $this->url->get('admin/public/captcha?t=') ?>'+Math.random();" src="<?= $this->url->get('admin/public/captcha', ['t' => time()]) ?>" alt="请输入验证码" />
                        </div>
                    </div>
                </div>
                <div class="form-group">
